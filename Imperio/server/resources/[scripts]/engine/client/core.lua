...
AddEventHandler("engine:Vehrify", function(Entitys)
	...
	if Entity(Vehicle)["state"]["Lockpick"] then
		exports["dynamic"]:AddButton("Chassi do Veículo", "Númeração <yellow>1"..Entitys[3].."3</yellow> adulterada.", "", "", false, false)
	else
		exports["dynamic"]:AddButton("Chassi do Veículo", "Numeração <yellow>2"..Entitys[3].."4</yellow> original.", "", "", false, false)
	end

	if Entity(Vehicle)["state"]["Drift"] then
		exports["dynamic"]:AddButton("Kit para Drifts", "Modificações <yellow>Instaladas</yellow>.", "", "", false, false)
	else
		exports["dynamic"]:AddButton("Kit para Drifts", "Modificações <yellow>Desinstaladas</yellow>.", "", "", false, false)
	end
	...
	exports["dynamic"]:AddButton("Freio Integral", "Freio Integral se encontra em <yellow>"..ForceBreak.."%</yellow>.", "", "", false, false)

	local FrontBreak = parseInt((Brakes[2] * 10000) / 55)
	exports["dynamic"]:AddButton("Freio Dianteiro", "Freio Dianteiro se encontra em <yellow>"..FrontBreak.."%</yellow>.", "", "", false, false)

	local HandsBreak = parseInt((Brakes[3] * 10000) / 75)
	exports["dynamic"]:AddButton("Freio Traseiro", "Freio Traseiro se encontra em <yellow>"..HandsBreak.."%</yellow>.", "", "", false, false)
