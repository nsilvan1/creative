...
-- RETURNWEAPON
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.ReturnWeapon()
	return Weapon ~= "" and Weapon or false
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- CHECKWEAPON
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.CheckWeapon(Hash)
...
-- CHECKATTACHS
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.CheckAttachs(Name,Hash)
	return Attachs[Name] and Attachs[Name][Hash]
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- EXISTATTACHS
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.ExistAttachs(Weapon)
	local Return = false
...
-- PUTATTACHS
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Attachs(Name,Hash)
	GiveWeaponComponentToPed(PlayerPedId(),Hash,Attachs[Name][Hash])
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- PUTWEAPONHANDS
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.TakeWeapon(Name, Ammo, Components, Type)
...
-- INFOWEAPON
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.InfoWeapon(Type)
	local Ammo = 0
	local Hash = nil
	local Status = false
...
-- RELOADING
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Reloading(Hash,Ammo)
...
-- CHECKFOUNTAIN
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.checkFountain()
	local Ped = PlayerPedId()
	local Coords = GetEntityCoords(Ped)
...
-- TYREHEALTH
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.tyreHealth(Network,Tyre)
	if NetworkDoesNetworkIdExist(Network) then
		local Vehicle = NetToEnt(Network)
		if DoesEntityExist(Vehicle) then
...
-- CHECKMODS
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.CheckMods(Vehicle, Mod)
...
-- CHECKCAR
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.CheckCar(Vehicle)
...
-- ACTIVEMODS
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.ActiveMods(Vehicle, Plate, Mod, Number)
	if NetworkDoesNetworkIdExist(Vehicle) then
		local Vehicle = NetToEnt(Vehicle)
		if DoesEntityExist(Vehicle) then
			if GetVehicleNumberPlateText(Vehicle) == Plate then
...
-- RESTAURANT
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Restaurant(Name)
	local Return = false
	local Ped = PlayerPedId()
	local Coords = GetEntityCoords(Ped)
