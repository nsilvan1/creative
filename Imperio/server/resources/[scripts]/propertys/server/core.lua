...
-----------------------------------------------------------------------------------------------------------------------------------------
Imperio = {}
Tunnel.bindInterface("propertys",Imperio)
...
-- ROBBERY
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Robbery(Name,Number)
	local source = source
...
-- POLICE
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Police(Coords)
	local source = source
...
-- PAYBERRY
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Paybbery(Name,Number)
	local source = source
	local Passport = vRP.Passport(source)
...
-- PROPERTYS
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Propertys(Name)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
...
-- TOGGLE
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Toggle(Name,Mode)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
		if Mode == "Exit" then
...
-- PERMISSION
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Permission(Name)
	local source = source
	local Passport = vRP.Passport(source)
	local Consult = vRP.Query("propertys/Exist",{ Name = Name })
	if Passport and Consult[1] and (vRP.InventoryFull(Passport,"propertys-"..Consult[1]["Serial"]) or Consult[1]["Passport"] == Passport) then
...
-- REQUEST
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Request(Name,Mode)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
		local Chest = {}
...
-- STORE
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Store(Item,Slot,Amount,Target,Name,Mode)
	local source = source
...
-- TAKE
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Take(Slot,Amount,Target,Name,Mode)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport then
...
-- UPDATE
-----------------------------------------------------------------------------------------------------------------------------------------
function Imperio.Update(Slot,Target,Amount,Name,Mode)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport then
