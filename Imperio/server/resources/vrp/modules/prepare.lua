...
-- CLEARTABLES
-----------------------------------------------------------------------------------------------------------------------------------------
vRP.Prepare("imperio/Playerdata","DELETE FROM playerdata WHERE Information = '[]' OR Information = '{}'")
vRP.Prepare("imperio/Entitydata","DELETE FROM entitydata WHERE Information = '[]' OR Information = '{}'")
vRP.Prepare("imperio/Transactions","DELETE FROM transactions WHERE UNIX_TIMESTAMP() >= Timeset")
vRP.Prepare("imperio/Painel","DELETE FROM painel WHERE UNIX_TIMESTAMP() >= Timeset")
vRP.Prepare("imperio/Premium","UPDATE accounts SET Premium = '0' WHERE UNIX_TIMESTAMP() >= Premium")
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSTART
-----------------------------------------------------------------------------------------------------------------------------------------
CreateThread(function()
	vRP.Query("imperio/Premium")
	vRP.Query("imperio/Playerdata")
	vRP.Query("imperio/Entitydata")
	vRP.Query("imperio/Transactions")
end)